      ...
      <MainContent>
        ...
        <Box>
          ...
          <RowBox>
            ...
            <ButtonBox elevation={3} onClick={() => handleOpen('Preacher Curl')}>
              <Typography variant="h6">Preacher Curl</Typography>
            </ButtonBox>
          </RowBox>

          {/* Third Row */}
          <RowBox>
            <ButtonBox elevation={3} onClick={() => handleOpen('Cable Curl')}>
              <Typography variant="h6">Cable Curl</Typography>
            </ButtonBox>
